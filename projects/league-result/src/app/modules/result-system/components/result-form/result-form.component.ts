...
export class ResultFormComponent extends ResultSystemBase
   ...
   */
  private forbiddenNameValidator(propName: string): ValidatorFn {
  ...
  private initForm(): void {
    this.resultForm = this.fb.group({
      ...
      homeTeam: [
        '',
        [Validators.required, this.forbiddenNameValidator('awayTeam')]
      ],
      homeScore: [0, [Validators.min(0), Validators.required]],
      awayTeam: [
        '',
        [Validators.required, this.forbiddenNameValidator('homeTeam')]
      ],

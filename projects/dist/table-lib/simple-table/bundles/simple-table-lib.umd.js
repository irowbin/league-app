(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('simple-table-lib', ['exports', '@angular/core', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['simple-table-lib'] = {}, global.ng.core, global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var SimpleTableLibComponent = /** @class */ (function () {
        ...
        SimpleTableLibComponent.prototype.ngOnChanges = function () {
            ...
            var copy = this.columnConfig.map(function (c) { return (Object.assign({}, c)); });
            this.columnProps = this.showRowNumber
                ? __spreadArray([{ caption: '#', dataField: '#' }], __read(copy)) : copy;
        };
    ...
    var SimpleTableLibModule = /** @class */ (function () {
        function SimpleTableLibModule() {
        }
        return SimpleTableLibModule;
    }());
    SimpleTableLibModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: SimpleTableLibModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    SimpleTableLibModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: SimpleTableLibModule, declarations: [SimpleTableLibComponent], imports: [i1.CommonModule], exports: [SimpleTableLibComponent] });
    SimpleTableLibModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: SimpleTableLibModule, imports: [[i1.CommonModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: SimpleTableLibModule, decorators: [{
                type: i0.NgModule,
                args: [{
    ...
    exports.SimpleTableLibComponent = SimpleTableLibComponent;
    exports.SimpleTableLibModule = SimpleTableLibModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=simple-table-lib.umd.js.map
